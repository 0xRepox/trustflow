...
@genType
and entities = {
    @as("ClaimEvent") claimEvent: entityStoreOperations<Entities.ClaimEvent.t>,
    @as("Dispute") dispute: entityStoreOperations<Entities.Dispute.t>,
    @as("Plan") plan: entityStoreOperations<Entities.Plan.t>,
    @as("Stream") stream: entityStoreOperations<Entities.Stream.t>,
  }
  ...
  let entities = {
      claimEvent: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ClaimEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ClaimEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      dispute: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Dispute)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Dispute.t,
            >
      ...
      plan: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Plan)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Plan.t,
            >
      ...
      stream: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Stream)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Stream.t,
            >
