...
export type entities = {
  readonly ClaimEvent: entityStoreOperations<Entities_ClaimEvent_t>; 
  readonly Dispute: entityStoreOperations<Entities_Dispute_t>; 
  readonly Plan: entityStoreOperations<Entities_Plan_t>; 
  readonly Stream: entityStoreOperations<Entities_Stream_t>
};
